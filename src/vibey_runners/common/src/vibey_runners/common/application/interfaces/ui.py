...
"""The live view seam. The concrete terminal UI toolkit stays in each
runner's own infrastructure layer."""
...
class StreamUi(Protocol):
    """Optional full-screen stream UI, fed deltas and turn boundaries."""
