...
import codexloop.application as application_pkg
from codexloop.application import interfaces, ports
...
# codexloop.application.interfaces or .ports needs to change.
...
def test_ports_shim_still_exports_the_same_names() -> None:
    """The move must not break `from codexloop.application.ports import X`."""
