...
- **`commit-msg`** — appends the repository's fingerprint trailer
  (`Made-With: …`, see [CLAUDE.md](https://github.com/the-vibey-project/vibey-skills/blob/main/CLAUDE.md#the-fingerprint))
...
[.github/workflows/provenance.yml](https://github.com/the-vibey-project/vibey-skills/blob/main/.github/workflows/provenance.yml)
and
[.github/workflows/ci.yml](https://github.com/the-vibey-project/vibey-skills/blob/main/.github/workflows/ci.yml),
