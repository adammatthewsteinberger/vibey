...
description: How vibey drives claudeloop, codexloop, cursorloop, agyloop, and the opt-in qwenloop — the engine adapter pattern, argv building, and the conformance suite.
